...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    //   setLoading(false);
    // } else {
    //   // AuthContext and Middleware will handle the redirect
    //   router.push("/");
    // }
  };
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[var(--background)] relative overflow-hidden">
      ...
      <div className="absolute bottom-[-10%] right-[-10%] w-96 h-96 bg-purple-500 rounded-full mix-blend-multiply filter blur-[128px] opacity-20 animate-blob animation-delay-2000"></div>
      ...
      <div className="w-full max-w-md p-8 rounded-3xl bg-[var(--glass-bg)] backdrop-blur-xl border border-[var(--glass-border)] shadow-2xl z-10">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-[var(--foreground)] opacity-60">Sign in to access your dashboard</p>
        </div>
